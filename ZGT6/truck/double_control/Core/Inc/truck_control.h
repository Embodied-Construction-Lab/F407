...
#define TRUCK_LIFT_UP_MAX_PERCENT 90
#define TRUCK_LIFT_DOWN_MAX_PERCENT 90
#define TRUCK_ESC_BRAKE_TIME_MS 300U
#define TRUCK_ESC_REVERSE_NEUTRAL_TIME_MS 200U

#define TRUCK_RAW_STEERING_DIRECTION 1.0f
#define TRUCK_RAW_PEDAL_RELEASED 1.0f
#define TRUCK_RAW_PEDAL_PRESSED (-1.0f)
#define TRUCK_RAW_PEDAL_DEAD_ZONE 0.02f
