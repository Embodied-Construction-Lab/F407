...
#define TRUCK_STEERING_CENTER_DEG 90.0f
#define TRUCK_STEERING_MAX_DELTA_DEG 30.0f
...
#define TRUCK_PEDAL_RELEASED_RAW 1.0f
#define TRUCK_PEDAL_PRESSED_RAW (-1.0f)
