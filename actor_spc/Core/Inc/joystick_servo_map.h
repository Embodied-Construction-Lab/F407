...
#define JOYSTICK_BUCKET_NEGATIVE_MIN_DEG 70.0f
#define JOYSTICK_BUCKET_NEGATIVE_MAX_DEG 78.0f

#define JOYSTICK_BIG_ARM_POSITIVE_MIN_DEG 105.0f
#define JOYSTICK_BIG_ARM_POSITIVE_MAX_DEG 112.0f
#define JOYSTICK_BIG_ARM_NEGATIVE_MIN_DEG 70.0f
...
#define JOYSTICK_SMALL_ARM_NEGATIVE_MAX_DEG 78.0f

#define JOYSTICK_SWING_MAX_PERCENT 30.0f
#define JOYSTICK_FIXED_PUMP_PERCENT (-20.0f)
