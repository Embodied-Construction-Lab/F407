...
#define JOYSTICK_DEAD_ZONE MANUAL_ACTION_DEAD_ZONE
#define JOYSTICK_CONTROL_TIMEOUT_MS 300U
#define JOYSTICK_PCA_CHANNEL_COUNT 8U

#define JOYSTICK_VALVE_NEUTRAL_DEG 90.0f

#define JOYSTICK_BUCKET_POSITIVE_MIN_DEG 105.0f
#define JOYSTICK_BUCKET_POSITIVE_MAX_DEG 110.0f
#define JOYSTICK_BUCKET_NEGATIVE_MIN_DEG 71.0f
#define JOYSTICK_BUCKET_NEGATIVE_MAX_DEG 76.0f

#define JOYSTICK_BIG_ARM_POSITIVE_MIN_DEG 110.0f
#define JOYSTICK_BIG_ARM_POSITIVE_MAX_DEG 115.0f
#define JOYSTICK_BIG_ARM_NEGATIVE_MIN_DEG 73.0f
#define JOYSTICK_BIG_ARM_NEGATIVE_MAX_DEG 78.0f

#define JOYSTICK_SMALL_ARM_POSITIVE_MIN_DEG 105.0f
#define JOYSTICK_SMALL_ARM_POSITIVE_MAX_DEG 110.0f
#define JOYSTICK_SMALL_ARM_NEGATIVE_MIN_DEG 69.0f
#define JOYSTICK_SMALL_ARM_NEGATIVE_MAX_DEG 75.0f

#define JOYSTICK_SWING_MAX_PERCENT 20.0f
#define JOYSTICK_FIXED_PUMP_PERCENT (-30.0f)
