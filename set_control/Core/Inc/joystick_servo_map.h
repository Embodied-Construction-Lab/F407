...
#define JOYSTICK_BUCKET_POSITIVE_MIN_DEG 106.0f
#define JOYSTICK_BUCKET_POSITIVE_MAX_DEG 112.0f
#define JOYSTICK_BUCKET_NEGATIVE_MIN_DEG 72.0f
#define JOYSTICK_BUCKET_NEGATIVE_MAX_DEG 80.0f

#define JOYSTICK_BIG_ARM_POSITIVE_MIN_DEG 110.0f
#define JOYSTICK_BIG_ARM_POSITIVE_MAX_DEG 115.0f
#define JOYSTICK_BIG_ARM_NEGATIVE_MIN_DEG 76.0f
#define JOYSTICK_BIG_ARM_NEGATIVE_MAX_DEG 80.0f

#define JOYSTICK_SMALL_ARM_POSITIVE_MIN_DEG 106.0f
#define JOYSTICK_SMALL_ARM_POSITIVE_MAX_DEG 112.0f
#define JOYSTICK_SMALL_ARM_NEGATIVE_MIN_DEG 70.0f
#define JOYSTICK_SMALL_ARM_NEGATIVE_MAX_DEG 80.0f
