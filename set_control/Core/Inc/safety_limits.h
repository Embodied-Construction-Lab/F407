...
#define SAFETY_LIMIT_SWING_MIN_DEG (-45.0f)
#define SAFETY_LIMIT_SWING_MAX_DEG 45.0f

#define SAFETY_LIMIT_SWING_POSITIVE_INCREASES_YAW 1U
#define SAFETY_LIMIT_BUCKET_POSITIVE_INCREASES_LENGTH 1U
#define SAFETY_LIMIT_STICK_POSITIVE_INCREASES_LENGTH 1U
#define SAFETY_LIMIT_BOOM_POSITIVE_INCREASES_LENGTH 0U
